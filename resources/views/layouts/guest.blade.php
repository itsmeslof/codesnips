...
<body class="font-sans text-zinc-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-zinc-900">
        <div class="flex flex-col items-center space-y-2">
            <a
                href="/"
                class="focusable rounded-md"
            >
                {{-- <x-application-logo class="w-20 h-20 fill-current text-zinc-500" /> --}}
                <p class="text-zinc-50 text-3xl font-semibold">
                    code<span class="text-cyan-400">snips</span>
                </p>
            </a>
            <p class="text-zinc-200">Self-hosted S3 compatible code snippet storage</p>
        </div>
