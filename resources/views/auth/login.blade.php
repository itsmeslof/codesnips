        ...
        <div class="flex items-center justify-between mt-8">
            ...
            >
                <input
                    id="remember_me"
                    type="checkbox"
                    class="rounded dark:bg-zinc-900 border-zinc-300 dark:border-zinc-700 text-sky-600 shadow-sm focus:ring-sky-500 dark:focus:ring-sky-600 dark:focus:ring-offset-zinc-800"
                    name="remember"
                >
