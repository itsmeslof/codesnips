...
{
    const STYLES = 'rounded-md text-cyan-50 bg-cyan-600 border-2 border-cyan-600 hover:bg-cyan-500 hover:border-cyan-500 active:bg-cyan-700 focus:bg-cyan-700 active:border-cyan-700 focus:border-cyan-700';
